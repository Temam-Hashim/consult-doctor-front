			...
			<section class="section section-specialities">
				<div class="container-fluid">
					<div class="section-header text-center">
						...
						<p class="sub-title">Find The best clicnic with professional specialist at our black doctor consultancy system.</p>
					</div>
				   ...
				   <div class="row">
						<div class="col-lg-4">
							<div class="section-header ">
								...
								<p>Book and get in touch with Doctor </p>
							</div>
							...
							<div class="col-lg-3 col-md-6">
								...
								<div class="footer-widget footer-about">
									...
									<div class="footer-about-content">
										<p>Find The best clicnic with professional specialist at our black doctor consultancy system.. </p>
								...
								<div class="footer-widget footer-contact">
									...
									<div class="footer-contact-info">
										<div class="footer-address">
											...
											<p> Meganagn,Amare and his Family BLDG<br> Addis Ababa, Ethiopia </p>
										</div>
										<p>
							...
							<div class="row">
								<div class="col-md-6 col-lg-6">
									<div class="copyright-text">
										<p class="mb-0"><a href="temxtech.66ghz.com.net">TemxTech</a></p>
									</div>
								</div>
								<div class="col-md-6 col-lg-6">
